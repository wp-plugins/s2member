...
echo '<p>This is a comma delimited list of additional form fields to collect during registration. All of these Custom Fields will remain optional to the User. That is, the User will NOT be *required* to enter any of these values. Some fields are already built-in by default. The defaults are: <code>Username, Email, First Name, Last Name</code>. If you need to add other Custom Fields, in addition to these defaults, you can do that here.</p>' . "\n";
...
else /* Otherwise, display some information related to the use of these fields in the s2Member API. */
	echo '<p><em>* These Custom Fields are also made available through the s2Member API. Please check the <code>Advanced Scripting</code> section for details.</em></p>' . "\n";
/**/
echo '<table class="form-table">' . "\n";
echo '<tbody>' . "\n";
echo '<tr>' . "\n";
...
echo 'Comma delimited please. <em>Ex: <code>Website URL, Street Address, City, State, Zip Code, Phone</code></em>' . "\n";
echo '</td>' . "\n";
/**/
echo '</tr>' . "\n";
echo '</tbody>' . "\n";
