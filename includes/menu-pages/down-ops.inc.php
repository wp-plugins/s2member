...
echo '<div class="ws-menu-page-hr"></div>' . "\n";
/**/
echo '<h3>s2Member provides you with the ability to upload restricted files to this security-enabled directory:</strong> <code>' . preg_replace ("/^" . preg_quote ($_SERVER["DOCUMENT_ROOT"], "/") . "/", "", $GLOBALS["WS_PLUGIN__"]["s2member"]["c"]["files_dir"]) . '</code></h3>' . "\n";
...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-hr ws-plugin--s2member-limit-exceeded-section-hr"></div>' . "\n";
/**/
