...
if (get_option("ws_plugin__s2member_configured") && $GLOBALS["WS_PLUGIN__"]["s2member"]["o"]["paypal_business"])
	{
		...
		echo '<p>Just customize the form fields provided, then press \'Generate Button Code\'. These special subscription buttons are customized to work with s2Member seamlessly. User accounts will be activated instantly in an automated fashion, and when you, or a User, cancels their membership or fails to make payments on time, s2Member will automatically terminate their membership privileges in an automated fashion. s2Member makes extensive use of the PayPal® IPN service, which receives updates directly from PayPal® behind the scenes.</p>' . "\n";
		/**/
		...
		echo '<p>Then, I want to charge: $<input type="text" id="ws-plugin--s2member-level1-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-level1-term"><option value="W">Weekly</option><option value="M" selected="selected">Monthly</option><option value="Y">Yearly</option></select></p>' . "\n";
		echo '<p>Using Page Style: <input type="text" id="ws-plugin--s2member-level1-page-style" value="paypal" size="10" /> <input type="button" value="Generate Button Code" onclick="ws_plugin__s2member_paypalButtonGenerate(1);" /></p>' . "\n";
		echo '</td>' . "\n";
		/**/
		echo '</tr>' . "\n";
		echo '<tr>' . "\n";
		...
		echo '</div>' . "\n";
		/**/
		echo '<div class="ws-menu-page-hr ws-plugin--s2member-button-code-2-section-hr"></div>' . "\n";
		/**/
		...
		echo '<p>Then, I want to charge: $<input type="text" id="ws-plugin--s2member-level2-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-level2-term"><option value="W">Weekly</option><option value="M" selected="selected">Monthly</option><option value="Y">Yearly</option></select></p>' . "\n";
		echo '<p>Using Page Style: <input type="text" id="ws-plugin--s2member-level2-page-style" value="paypal" size="10" /> <input type="button" value="Generate Button Code" onclick="ws_plugin__s2member_paypalButtonGenerate(2);" /></p>' . "\n";
		echo '</td>' . "\n";
		/**/
		echo '</tr>' . "\n";
		echo '<tr>' . "\n";
		...
		echo '</div>' . "\n";
		/**/
		echo '<div class="ws-menu-page-hr ws-plugin--s2member-button-code-3-section-hr"></div>' . "\n";
		/**/
		...
		echo '<p>Then, I want to charge: $<input type="text" id="ws-plugin--s2member-level3-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-level3-term"><option value="W">Weekly</option><option value="M" selected="selected">Monthly</option><option value="Y">Yearly</option></select></p>' . "\n";
		echo '<p>Using Page Style: <input type="text" id="ws-plugin--s2member-level3-page-style" value="paypal" size="10" /> <input type="button" value="Generate Button Code" onclick="ws_plugin__s2member_paypalButtonGenerate(3);" /></p>' . "\n";
		echo '</td>' . "\n";
		/**/
		echo '</tr>' . "\n";
		echo '<tr>' . "\n";
		...
		echo '</div>' . "\n";
		/**/
		echo '<div class="ws-menu-page-hr ws-plugin--s2member-button-code-4-section-hr"></div>' . "\n";
		/**/
		...
		echo '<p>Then, I want to charge: $<input type="text" id="ws-plugin--s2member-level4-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-level4-term"><option value="W">Weekly</option><option value="M" selected="selected">Monthly</option><option value="Y">Yearly</option></select></p>' . "\n";
		echo '<p>Using Page Style: <input type="text" id="ws-plugin--s2member-level4-page-style" value="paypal" size="10" /> <input type="button" value="Generate Button Code" onclick="ws_plugin__s2member_paypalButtonGenerate(4);" /></p>' . "\n";
		echo '</td>' . "\n";
		/**/
		echo '</tr>' . "\n";
		echo '<tr>' . "\n";
