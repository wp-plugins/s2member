...
function ws_plugin__s2member_login_header_styles ()
	{
		...
		/**/
		echo 'div#login form input.s2member-custom-reg-field { background:none repeat scroll 0 0 #FBFBFB; border:1px solid #E5E5E5; font-size:24px; margin-bottom:16px; margin-right:6px; margin-top:2px; padding:3px; width:97%; }' . "\n";
		/**/
