...
if (apply_filters ("ws_plugin__s2member_during_options_page_during_left_sections_display_custom_reg_fields", true, get_defined_vars ()))
	{
		...
		/**/
		if (is_multisite () && c_ws_plugin__s2member_utils_conds::is_multisite_farm () && is_main_site () && !$GLOBALS["WS_PLUGIN__"]["s2member_pro"])
		...
		/**/
		echo '<td>' . "\n";
		echo '<select name="ws_plugin__s2member_custom_reg_password" id="ws-plugin--s2member-custom-reg-password"' . ( (is_multisite () && c_ws_plugin__s2member_utils_conds::is_multisite_farm () && is_main_site () && !$GLOBALS["WS_PLUGIN__"]["s2member_pro"]) ? ' disabled="disabled"' : '') . '>' . "\n";
...
/**/
if (apply_filters ("ws_plugin__s2member_during_options_page_during_left_sections_display_brute_force_restrictions", true, get_defined_vars ()))
	{
		do_action ("ws_plugin__s2member_during_options_page_during_left_sections_before_brute_force_restrictions", get_defined_vars ());
		/**/
...
if (apply_filters ("ws_plugin__s2member_during_options_page_during_left_sections_display_profile_modifications", true, get_defined_vars ()))
	{
		...
		echo '<p>Alternatively, s2Member also gives you the ability to send your Members to a <a href="' . esc_attr (site_url ("/?s2member_profile=1")) . '" target="_blank" rel="external">special Stand-Alone version</a>. This Stand-Alone version has been designed ( with a bare-bones format ), intentionally. This makes it possible for you to <a href="#" onclick="if(!window.open(\'' . site_url ("/?s2member_profile=1") . '\', \'_popup\', \'height=350,width=400,left=100,screenX=100,top=100,screenY=100,location=0,menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1\')) alert(\'Please disable popup blockers and try again!\'); return false;" rel="external">open it up in a popup window</a>, or embed it into your Login Welcome Page using an IFRAME. Code samples are provided below.</p>' . "\n";
...
/**/
if (apply_filters ("ws_plugin__s2member_during_options_page_during_left_sections_display_deactivation", (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site () || is_super_admin ()), get_defined_vars ()))
	{
