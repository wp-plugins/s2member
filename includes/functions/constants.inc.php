...
function ws_plugin__s2member_constants ()
	{
		...
		define ("S2MEMBER_CURRENT_USER_SUBSCR_ID", (($current_user) ? $metas["s2member_subscr_id"] : "")); /* This will always a (string). However, it will be empty if not logged in. */
		...
		define ("S2MEMBER_LOGIN_WELCOME_PAGE_URL", $links["login_welcome_page"]); /* Always a string. This is the URL to the login welcome page configured via options. */
